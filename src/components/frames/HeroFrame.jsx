...
export default function HeroFrame({ onNavigate, theme }) {
  ...
  return (
    <div className="flex flex-col gap-12 pt-[0px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative min-h-[500px] lg:min-h-0">
        ...
        {/* Right Side: 3D Möbius Ring Viewport */}
        <div className="lg:col-span-5 w-full h-[350px] sm:h-[400px] lg:h-[480px] relative z-0 mt-[-25px] lg:mt-0 border-3 border-border-base bg-card-bg shadow-brutal flex flex-col transition-all duration-300">
                 ...
                 <div className="p-3 border-t-3 border-border-base flex flex-col gap-2.5 bg-card-bg select-none">
                   ...
                   <div className="flex flex-col gap-1 border-b border-border-base/15 pb-2.5 mb-0.5">
                     ...
                     <div className="flex items-center gap-1.5 mt-0.5">
                       {['#00FF66', '#00F0FF', '#FF007F', '#FFE600'].map((color) => {
